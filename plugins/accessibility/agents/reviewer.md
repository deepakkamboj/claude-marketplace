...
3. **Accessibility analysis using skills**
   ...
   - **`accessibility:contrast-checker`**: For WCAG 1.4.3 Contrast (Minimum) and 1.4.11 Non-text Contrast
   ...
   - **`accessibility:use-of-color`**: For WCAG 1.4.1 Use of Color (Level A)
   ...
   - **`accessibility:link-purpose`**: For WCAG 2.4.4 Link Purpose (In Context) (Level A)
...
4. **Web accessibility review (for URLs)**
   ...
   d. **Analyze using skills**:
      ...
      - Invoke `accessibility:contrast-checker` with color data
      - Invoke `accessibility:use-of-color` to check for color-only indicators
      - Invoke `accessibility:link-purpose` to check link text
   ...
   **Example workflow**:
   ...
   4. Skill("accessibility:contrast-checker") with extracted color data
   5. Skill("accessibility:link-purpose") with extracted links
